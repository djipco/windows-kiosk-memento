...
* To stop the Windows Update Service install the [StopUpdates10](https://greatis.com/stopupdates10/) freeware. It also prevents Windows Update from reactivating itself.
